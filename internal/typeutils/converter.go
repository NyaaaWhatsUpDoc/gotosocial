...
type TypeConverter interface {
	...
	*/
	...
	StatusesToASOutboxPage(ctx context.Context, outboxID string, page *paging.Page[string], statuses []*gtsmodel.Status) (vocab.ActivityStreamsOrderedCollectionPage, error)
