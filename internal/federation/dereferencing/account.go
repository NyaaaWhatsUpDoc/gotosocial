...
func (d *Dereferencer) enrichAccount(
	...
	*/
	...
	if err := d.fetchAccountStats(ctx, latestAcc, requestUser); err != nil {
...
func (d *Dereferencer) fetchAccountStats(ctx context.Context, account *gtsmodel.Account, requestUser string) error {
