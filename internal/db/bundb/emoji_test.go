...
func (suite *EmojiTestSuite) TestGetAllEmojis() {
	emojis, err := suite.db.GetEmojisBy(context.Background(), db.EmojiAllDomains, true, true, "", nil)
...
func (suite *EmojiTestSuite) TestGetAllEmojisLimit1() {
	emojis, err := suite.db.GetEmojisBy(context.Background(), db.EmojiAllDomains, true, true, "", paging.New("", "", "", 1))
...
func (suite *EmojiTestSuite) TestGetAllEmojisMaxID() {
	pg := &paging.Page[string]{
		Max: paging.MaxShortcodeDomain("rainbow@"),
	}

	emojis, err := suite.db.GetEmojisBy(context.Background(), db.EmojiAllDomains, true, true, "", pg)
...
func (suite *EmojiTestSuite) TestGetAllEmojisMinID() {
	pg := &paging.Page[string]{
		Min: paging.MinShortcodeDomain("yell@fossbros-anonymous.io"),
	}
...
func (suite *EmojiTestSuite) TestGetAllDisabledEmojis() {
	emojis, err := suite.db.GetEmojisBy(context.Background(), db.EmojiAllDomains, true, false, "", nil)
...
func (suite *EmojiTestSuite) TestGetAllEnabledEmojis() {
	emojis, err := suite.db.GetEmojisBy(context.Background(), db.EmojiAllDomains, false, true, "", nil)
...
func (suite *EmojiTestSuite) TestGetLocalEnabledEmojis() {
	emojis, err := suite.db.GetEmojisBy(context.Background(), "", false, true, "", nil)
...
func (suite *EmojiTestSuite) TestGetLocalDisabledEmojis() {
	emojis, err := suite.db.GetEmojisBy(context.Background(), "", true, false, "", nil)
...
func (suite *EmojiTestSuite) TestGetAllEmojisFromDomain() {
	emojis, err := suite.db.GetEmojisBy(context.Background(), "peepee.poopoo", true, true, "", nil)
...
func (suite *EmojiTestSuite) TestGetAllEmojisFromDomain2() {
	emojis, err := suite.db.GetEmojisBy(context.Background(), "fossbros-anonymous.io", true, true, "", nil)
...
func (suite *EmojiTestSuite) TestGetSpecificEmojisFromDomain2() {
	emojis, err := suite.db.GetEmojisBy(context.Background(), "fossbros-anonymous.io", true, true, "yell", nil)
