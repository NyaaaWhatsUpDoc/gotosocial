...
type Media interface {
	...
	GetAttachments(ctx context.Context, page *paging.Page[string]) ([]*gtsmodel.MediaAttachment, error)

	// GetRemoteAttachments fetches media attachments with a non-empty domain, up to a given max ID, and at most limit.
	GetRemoteAttachments(ctx context.Context, page *paging.Page[string]) ([]*gtsmodel.MediaAttachment, error)
